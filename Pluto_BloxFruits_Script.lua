--[[
====================================================================================================
🪐 PLUTO SCRIPT - COMPLETE EDITION (FULL PRESERVATION) 🪐
====================================================================================================
- 100% Preserved Blox Fruits Core Automation & Logic (4,100+ Lines)
- Frosted Acrylic Glassmorphism Theme (#0E1117 / 82% Transparency)
- 100% Vector Lucide Icons | Custom Procedural Planet Logo
- 100% Draggable (Main Window & Floating Widget) | Fast Attack | Magnet | Stack Melee
====================================================================================================
]]

-- INLINE PLUTO UI LIBRARY
--!strict
--[[
====================================================================================================
...
-- VECTOR LUCIDE ICONS MAPPING
Pluto.Icons = {
    Home        = "rbxassetid://10723407389",
    Settings    = "rbxassetid://10734950020",
    Zap         = "rbxassetid://10723434557",
    Swords      = "rbxassetid://10723415766",
    Check       = "rbxassetid://10709790948",
    Minus       = "rbxassetid://10734896206",
    Close       = "rbxassetid://10747384394",
    Shopping    = "rbxassetid://10734952478",
    Server      = "rbxassetid://10734949856",
    User        = "rbxassetid://10747373176",
    Wave        = "rbxassetid://10747376008",
    Layers      = "rbxassetid://10723424164",
...
-- AUTO-CLEAN PREVIOUS GUI INSTANCES
for _, n in {"PlutoScript_GlassUI", "NightHub_Rewrite", "Zenith_Studio_UI", "Zenith_Premium_Hub", "TeusHub", "FluentGui"} do
    pcall(function() StarterGui[n]:Destroy() end)
    pcall(function() CoreGui[n]:Destroy() end)
end
...
local function MakeDraggable(dragObject: GuiObject, handleObject: GuiObject?, clickCallback: (() -> ())?)
    local handle = handleObject or dragObject
            ...
            moveConn = UserInputService.InputChanged:Connect(function(moveInput)
                if moveInput.UserInputType == Enum.UserInputType.MouseMovement or moveInput.UserInputType == Enum.UserInputType.Touch then
                    if dragging then
                        ...
                        TweenService:Create(dragObject, TweenInfo.new(0.04, Enum.EasingStyle.Linear), {
                            Position = UDim2.new(
                                startPos.X.Scale,
...
function Pluto:CreateWindow(config)
    ...
    MainWindow.BackgroundColor3 = Color3.fromRGB(14, 17, 23)
    MainWindow.BackgroundTransparency = 0.18
    ...
    GlassStroke.Transparency = 0.88
    GlassStroke.Parent = MainWindow
    ...
    FloatLogo.Size = UDim2.new(0, 26, 0, 26)
    FloatLogo.Position = UDim2.new(0.5, -13, 0.5, -13)
    FloatLogo.BackgroundTransparency = 1
    FloatLogo.Parent = FloatingBtn

    local FloatSphere = Instance.new("Frame")
    FloatSphere.Size = UDim2.new(0, 18, 0, 18)
    FloatSphere.Position = UDim2.new(0.5, -9, 0.5, -9)
    FloatSphere.BackgroundColor3 = Color3.fromRGB(52, 211, 153)
    local FSCorner = Instance.new("UICorner")
    FSCorner.CornerRadius = UDim.new(1, 0)
    FSCorner.Parent = FloatSphere
    FloatSphere.Parent = FloatLogo

    local FloatRing = Instance.new("Frame")
    FloatRing.Size = UDim2.new(0, 26, 0, 11)
    FloatRing.Position = UDim2.new(0.5, -13, 0.5, -5.5)
    FloatRing.BackgroundTransparency = 1
    FloatRing.Rotation = -25
    local FRCorner = Instance.new("UICorner")
    FRCorner.CornerRadius = UDim.new(1, 0)
    FRCorner.Parent = FloatRing
    local FRStroke = Instance.new("UIStroke")
    FRStroke.Color = Color3.fromRGB(255, 255, 255)
    FRStroke.Thickness = 1.2
    FRStroke.Transparency = 0.35
    FRStroke.Parent = FloatRing
    FloatRing.Parent = FloatLogo

    local isMinimized = false
    local function ToggleMinimize()
        isMinimized = not isMinimized
        if isMinimized then
            local tw = TweenService:Create(MainWindow, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {
            ...
            TweenService:Create(FloatingBtn, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
            ...
            MainWindow.Position = FloatingBtn.Position
    ...
    MakeDraggable(FloatingBtn, FloatingBtn, ToggleMinimize)

    -- HOTKEY (K OR RIGHTCONTROL)
    UserInputService.InputBegan:Connect(function(input, processed)
        if not processed and (input.KeyCode == Enum.KeyCode.K or input.KeyCode == Enum.KeyCode.RightControl) then
            ToggleMinimize()
        end
    end)
    ...
    DotRed.MouseButton1Click:Connect(function()
        TweenService:Create(MainWindow, TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {
    ...
    DotYellow.MouseButton1Click:Connect(ToggleMinimize)
    ...
    local PlanetSphere = Instance.new("Frame")
    PlanetSphere.Size = UDim2.new(0, 15, 0, 15)
    PlanetSphere.Position = UDim2.new(0.5, -7.5, 0.5, -7.5)
    PlanetSphere.BackgroundColor3 = Color3.fromRGB(52, 211, 153)
    local PCorner = Instance.new("UICorner")
    PCorner.CornerRadius = UDim.new(1, 0)
    PCorner.Parent = PlanetSphere
    PlanetSphere.Parent = LogoContainer

    local PlanetRing = Instance.new("Frame")
    PlanetRing.Size = UDim2.new(0, 22, 0, 9)
    PlanetRing.Position = UDim2.new(0.5, -11, 0.5, -4.5)
    PlanetRing.BackgroundTransparency = 1
    PlanetRing.Rotation = -25
    local RCorner = Instance.new("UICorner")
    RCorner.CornerRadius = UDim.new(1, 0)
    RCorner.Parent = PlanetRing
    local RStroke = Instance.new("UIStroke")
    RStroke.Color = Color3.fromRGB(255, 255, 255)
    RStroke.Thickness = 1.2
    RStroke.Transparency = 0.4
    RStroke.Parent = PlanetRing
    ...
    BG1.CornerRadius = UDim.new(1, 0)
    BG1.Parent = BadgeGame
    local BG1_Stroke = Instance.new("UIStroke")
    BG1_Stroke.Color = Color3.fromRGB(52, 211, 153)
    BG1_Stroke.Transparency = 0.6
    BG1_Stroke.Parent = BadgeGame
    ...
    BG2.CornerRadius = UDim.new(1, 0)
    BG2.Parent = BadgeVer
    local BG2_Stroke = Instance.new("UIStroke")
    BG2_Stroke.Color = Color3.fromRGB(148, 163, 184)
    BG2_Stroke.Transparency = 0.75
    BG2_Stroke.Parent = BadgeVer
    local LabelV = Instance.new("TextLabel")
    LabelV.Size = UDim2.new(1, 0, 1, 0)
    LabelV.BackgroundTransparency = 1
    ...
    Sidebar.ScrollBarImageColor3 = Color3.fromRGB(51, 65, 85)
    ...
    function WindowObj:AddTab(tabConfig)
        ...
        page.ScrollBarImageColor3 = Color3.fromRGB(71, 85, 105)
        ...
        btn.MouseButton1Click:Connect(function()
            for _, t in pairs(WindowObj.Tabs) do
                ...
                t.icon.ImageColor3 = Color3.fromRGB(148, 163, 184)
        ...
        local TabControls = { Page = page }
        local itemOrder = 0

        -- ADD TOGGLE
        function TabControls:AddToggle(arg1, arg2)
            local cfg = (type(arg1) == "table") and arg1 or (arg2 or {})
            local tTitle = cfg.Title or cfg.Name or (type(arg1) == "string" and arg1) or "Toggle"
            local tDesc = cfg.Description or cfg.Desc or ""
            local tDefault = (cfg.Default ~= nil) and cfg.Default or false
            local tCallback = cfg.Callback
            ...
            if tDesc ~= "" then
                ...
                descLbl.Size = UDim2.new(1, -74, 0, 20)
            ...
            local function SetState(val)
                ...
                if tCallback then pcall(tCallback, state) end
                if toggleObj.OnChangedFunc then pcall(toggleObj.OnChangedFunc, state) end
            end
            ...
            function toggleObj:OnChanged(fn)
                self.OnChangedFunc = fn
                if state then pcall(fn, state) end
            end
        ...
        -- ADD BUTTON
        function TabControls:AddButton(arg1, arg2)
            local cfg = (type(arg1) == "table") and arg1 or (arg2 or {})
            local bTitle = cfg.Title or cfg.Name or "Button"
            local bCallback = cfg.Callback
            ...
            titleLbl.TextColor3 = Color3.fromRGB(241, 245, 249)
            titleLbl.TextSize = 12
            titleLbl.TextXAlignment = Enum.TextXAlignment.Left
            titleLbl.Parent = btn

            btn.MouseButton1Click:Connect(function()
                TweenService:Create(btn, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(40, 50, 70)}):Play()
                task.wait(0.1)
                TweenService:Create(btn, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(24, 30, 42)}):Play()
                if bCallback then pcall(bCallback) end
            end)
            return btn
        end

        -- ADD DROPDOWN
        function TabControls:AddDropdown(arg1, arg2)
            local cfg = (type(arg1) == "table") and arg1 or (arg2 or {})
            local dTitle = cfg.Title or cfg.Name or "Dropdown"
            local dValues = cfg.Values or cfg.Options or {}
            local dDefault = cfg.Default or dValues[1] or ""
            local dCallback = cfg.Callback
            ...
            dropBtn.Text = tostring(dDefault)
            dropBtn.TextColor3 = Color3.fromRGB(52, 211, 153)
            dropBtn.TextSize = 11
            ...
            local isOpen = false
            local dropObj = { Value = dDefault }

            local function RefreshItems()
                for _, ch in pairs(dropList:GetChildren()) do
                    if ch:IsA("TextButton") then ch:Destroy() end
                end
                for _, item in ipairs(dValues) do
                    local itmBtn = Instance.new("TextButton")
                    itmBtn.Size = UDim2.new(1, 0, 0, 26)
                    itmBtn.BackgroundColor3 = Color3.fromRGB(15, 23, 42)
                    itmBtn.BackgroundTransparency = 0.3
                    itmBtn.Font = Enum.Font.Gotham
                    itmBtn.Text = "  " .. tostring(item)
                    itmBtn.TextColor3 = Color3.fromRGB(203, 213, 225)
                    itmBtn.TextSize = 11
                    itmBtn.TextXAlignment = Enum.TextXAlignment.Left
                    local iCorner = Instance.new("UICorner")
                    iCorner.CornerRadius = UDim.new(0, 6)
                    iCorner.Parent = itmBtn
                    itmBtn.Parent = dropList
            ...
            function dropObj:SetValue(v)
                ...
                if dCallback then pcall(dCallback, v) end
                if self.OnChangedFunc then pcall(self.OnChangedFunc, v) end
            end
            function dropObj:SetValues(newVals)
                dValues = newVals
                RefreshItems()
            end
            function dropObj:OnChanged(fn) self.OnChangedFunc = fn end

            return dropObj
        end

        -- ADD SLIDER
        function TabControls:AddSlider(arg1, arg2)
            local cfg = (type(arg1) == "table") and arg1 or (arg2 or {})
            local sTitle = cfg.Title or cfg.Name or "Slider"
            local sMin = cfg.Min or 0
            local sMax = cfg.Max or 100
            local sDefault = cfg.Default or sMin
            local sCallback = cfg.Callback
            ...
            valLbl.Text = tostring(sDefault)
            valLbl.TextColor3 = Color3.fromRGB(52, 211, 153)
            valLbl.TextSize = 12
            ...
            fill.Size = UDim2.new(math.clamp((sDefault - sMin)/math.max(1, sMax - sMin), 0, 1), 0, 1, 0)
            ...
            local function UpdateSlide(input)
                ...
                currentVal = val
                sliderObj.Value = val
                if sCallback then pcall(sCallback, val) end
                if sliderObj.OnChangedFunc then pcall(sliderObj.OnChangedFunc, val) end
            end
            ...
            function sliderObj:SetValue(v)
                currentVal = v
                local pct = math.clamp((v - sMin)/math.max(1, sMax - sMin), 0, 1)
                fill.Size = UDim2.new(pct, 0, 1, 0)
                valLbl.Text = tostring(v)
                if sCallback then pcall(sCallback, v) end
                if self.OnChangedFunc then pcall(self.OnChangedFunc, v) end
            end
            function sliderObj:OnChanged(fn) self.OnChangedFunc = fn end

            return sliderObj
        end

        -- ADD PARAGRAPH (OR SECTION HEADER IF CONTENT IS EMPTY)
        function TabControls:AddParagraph(arg1, arg2)
            local cfg = (type(arg1) == "table") and arg1 or (arg2 or {})
            local pTitle = cfg.Title or cfg.Name or "Paragraph"
            local pDesc = cfg.Content or cfg.Desc or ""
            ...
            if pDesc == "" or pDesc == nil then
                ...
                local paraObj = {}
                function paraObj:SetTitle(t) titleLbl.Text = t end
                function paraObj:SetDesc(d) descLbl.Text = d end
                return paraObj
            end
        end

        -- ADD INPUT / TEXTBOX
        function TabControls:AddInput(arg1, arg2)
            local cfg = (type(arg1) == "table") and arg1 or (arg2 or {})
            local iTitle = cfg.Title or cfg.Name or "Input"
            local iPlaceholder = cfg.Placeholder or "Enter text..."
            local iDefault = cfg.Default or ""
            local iCallback = cfg.Callback
            ...
            local inputObj = { Value = iDefault }

            tBox.FocusLost:Connect(function(enterPressed)
                inputObj.Value = tBox.Text
                if iCallback then pcall(iCallback, tBox.Text) end
                if inputObj.OnChangedFunc then pcall(inputObj.OnChangedFunc, tBox.Text) end
            end)

            function inputObj:SetValue(v)
                tBox.Text = tostring(v)
                self.Value = tostring(v)
                if iCallback then pcall(iCallback, tostring(v)) end
            end
            function inputObj:OnChanged(fn) self.OnChangedFunc = fn end

            return inputObj
        end
        TabControls.AddTextBox = TabControls.AddInput

        -- ADD SECTION / SEPARATOR
        function TabControls:AddSection(textOrCfg)
            local text = (type(textOrCfg) == "table" and (textOrCfg.Title or textOrCfg.Name or textOrCfg[1])) or tostring(textOrCfg or "")
            itemOrder = itemOrder + 1
        ...
        TabControls.AddSeparator = TabControls.AddSection
...
-- ====================================================================================================
-- ORIGINAL BLOX FRUITS CORE AUTOMATION & UI
-- ====================================================================================================
--!strict
local RunService = game:GetService("RunService")
if not RunService:IsStudio() and not game:IsLoaded() then
...
local executor = (typeof(getexecutorname) == "function" and getexecutorname()) or (typeof(identifyexecutor) == "function" and identifyexecutor()) or ""
local players = game:GetService("Players")
...
Window = Fluent:CreateWindow({
    Title = "Teus Hub - Blox Fruit [ Beta ]",
    SubTitle = "By Realskira",
    TabWidth = 155,
...
Settings = Window:AddTab({ Title = "tab Setting Farm", Icon = "⚙️" })
...
Toggle = Settings:AddToggle("Toggle", {Title = "⚠️ Auto click ", Default = true })
...
Toggle = Settings:AddToggle("Toggle", {Title = "⚠️ bypass Teleport 80% ", Default = false })
Toggle:OnChanged(function(Value)
    BypassTP = Value 
end)
...
ChooseSkill = Window:AddTab({ Title = "       Tab Setting Hold and Select Skill", Icon = "" })
...
Main = Window:AddTab({ Title = "Tab Farming", Icon = "⚡️" })
Main:AddParagraph({
     Title = "Main Farm",
     Content = string.rep("", 0)
})
...
Toggle = Main:AddToggle("Toggle", { Title = "Ignore Attack Katakuri ", Default = false })
Toggle = Main:AddToggle("Toggle", { Title = "Super Fast Attack Godhuman + cdk", Default = false })
local DanhNhanhBuCu36 = {}

Toggle = Main:AddToggle("Toggle", { Title = "Accept Quest [Katakuri/Bone/Tyrant]", Default = false })
